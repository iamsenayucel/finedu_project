...
interface CreditFinancingGlossaryPuzzleProps {
...
const WORDS: WordDef[] = [
  {
    ...
    answer: 'GECİKMEFAİZİ',
    label: 'GECİKME FAİZİ',
    clue: 'Kredi kartı veya tüketici kredisi geri ödemelerinin, sözleşmede belirlenen son ödeme tarihine kadar asgari tutarının ödenmemesi (temerrüde düşülmesi) halinde, asgari tutar üzerinden tahakkuk ettirilen cezai orandır.',
  },
  {
    id: 'pesin_fiyat',
    number: 2,
    ...
    answer: 'PEŞİNFİYAT',
    label: 'PEŞİN FİYAT',
    clue: 'Bir mal veya hizmetin mülkiyetinin devri karşılığında, herhangi bir vade farkı, faiz veya finansman maliyeti eklenmeksizin işlemin gerçekleştiği anda defaten ödenen spot bedelidir.',
  },
  {
    id: 'kredi_maliyeti',
    number: 3,
    ...
    row: 5,
    col: 6,
    answer: 'KREDİMALİYETİ',
    label: 'KREDİ MALİYETİ',
    clue: 'Bir fonun geçici olarak kullanım hakkının devredilmesi karşılığında, anapara üzerine tahakkuk eden faiz, vergi, fon ve diğer tüm masrafları kapsayan toplam finansman yüküdür.',
  },
  {
    id: 'nakit_avans',
    number: 4,
    ...
    answer: 'NAKİTAVANS',
    label: 'NAKİT AVANS',
    clue: 'Kredi kartı limitinin belirli bir kısmı dahilinde, kart hamiline nakit çekim imkânı sunan ve genellikle standart harcamalara kıyasla daha yüksek faiz oranına tabi olan kısa vadeli finansman işlemidir.',
  },
  {
    id: 'ekstre',
    number: 5,
    ...
    answer: 'EKSTRE',
    label: 'EKSTRE',
    clue: 'Kredi kartı hamillerinin belirli bir hesap dönemi içerisindeki tüm işlem hareketlerini, tahakkuk eden faiz, ücret ve komisyonları ile asgari ödeme yükümlülüklerini gösteren resmi bildirim belgesidir.',
  },
  {
    id: 'kredi_notu',
    number: 6,
    ...
    answer: 'KREDİNOTU',
    label: 'KREDİ NOTU',
    clue: 'Bireylerin veya kurumların geçmiş dönemlerdeki finansal yükümlülüklerini yerine getirme performanslarına dayalı olarak Kredi Kayıt Bürosu (KKB) gibi kurumlarca hesaplanan risk derecelendirme puanıdır.',
  },
  {
    id: 'asgari_odeme',
    number: 7,
    ...
    answer: 'ASGARİÖDEME',
    label: 'ASGARİ ÖDEME',
    clue: 'Kredi kartı sözleşmesine istinaden, hesap kesim tarihinde tahakkuk eden toplam dönem borcunun, yasal düzenlemelerle belirlenen ve son ödeme tarihine kadar ifa edilmesi zorunlu olan asgari kısmıdır.',
  },
  {
    id: 'finansman_gideri',
    number: 8,
    ...
    row: 9,
    col: 5,
    answer: 'FİNANSMANGİDERİ',
    label: 'FİNANSMAN GİDERİ',
    clue: 'İşletmelerin veya bireylerin faaliyetlerini veya yatırımlarını finanse etmek amacıyla sağladıkları yabancı kaynakların kullanımı nedeniyle katlandıkları faiz, kur farkı, komisyon ve benzeri masrafların bütünüdür.',
  },
  {
    id: 'vade',
    number: 9,
...
const CHIP_TYPE = 'CREDIT_FINANCING_GLOSSARY_ANSWER';
...
function CreditFinancingGlossaryPuzzleGame({ onComplete, onBack }: CreditFinancingGlossaryPuzzleProps) {
        ...
        <div className="bg-slate-900 rounded-3xl overflow-hidden shadow-2xl border border-slate-700">
          ...
          <div className="p-6 sm:p-8 text-center">
            ...
            <h1 className="text-2xl md:text-3xl font-black text-white mb-2">
              Akademik Kredi ve Finansman — Ekonomi Sözlüğü
            </h1>
  ...
  if (stage === 'finished') {
    ...
    const perf =
      wrongCount === 0
        ...
        : wrongCount <= 3
        ? { icon: '🌟', title: 'Harika İş!', sub: 'Kredi ve finansman kavramlarına çok hakimsin.', grad: 'from-cyan-600 to-teal-500' }
        : wrongCount <= 6
    ...
    <div className="w-full max-w-7xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-cyan-600 to-teal-600 rounded-2xl px-5 py-3 mb-4 flex items-center justify-between shadow-lg flex-wrap gap-2">
        <div className="flex items-center gap-3">
          ...
          <span className="text-white font-black text-base">Akademik Kredi ve Finansman — Sürükle Bırak Bulmaca</span>
        </div>
        <div className="flex items-center gap-3">
...
export default function CreditFinancingGlossaryPuzzle(props: CreditFinancingGlossaryPuzzleProps) {
  return (
    <DndProvider backend={MultiBackend} options={HTML5toTouch}>
      <CreditFinancingGlossaryPuzzleGame {...props} />
    </DndProvider>
  );
}
