...
interface ShortLongTermGlossaryPuzzleProps {
...
const WORDS: WordDef[] = [
  {
    ...
    answer: 'KISAVADE',
    label: 'KISA VADE',
    clue: 'Finansal etkileri genellikle gün veya hafta gibi anlık sürelerde ortaya çıkan zaman dilimi (İki kelime).',
  },
  {
    id: 'uzun_vade',
    number: 2,
    ...
    answer: 'UZUNVADE',
    label: 'UZUN VADE',
    clue: 'Stratejik hedefleri kapsayan ve finansal etkileri yıllara yayılan geniş zaman dilimi (İki kelime).',
  },
  {
    id: 'bilesik_getiri',
    number: 3,
    ...
    answer: 'BİLEŞİK',
    label: 'BİLEŞİK',
    clue: 'Ana paranın yanı sıra elde edilen kazancın da yeniden yatırıma dönüştüğü getiri türü.',
  },
  {
    id: 'sahte_tasarruf',
    number: 4,
    ...
    answer: 'SAHTE',
    label: 'SAHTE',
    clue: 'Kalitesiz ürün tercihinden doğan ve uzun vadede tekrar masraf çıkaran tasarruf yanılgısı.',
  },
  {
    id: 'durtusel_harcama',
    number: 5,
    ...
    answer: 'DÜRTÜSEL',
    label: 'DÜRTÜSEL',
    clue: 'Rasyonel bir planlamaya dayanmayan, anlık hevesle gerçekleşen (harcama türü).',
  },
  {
    id: 'ihtiyac',
    number: 6,
    ...
    answer: 'İHTİYAÇ',
    label: 'İHTİYAÇ',
    clue: 'İnsan yaşamının sürdürülebilmesi için karşılanması zorunlu olan temel gereksinimler.',
  },
  {
    id: 'acil_durum',
    number: 7,
    ...
    answer: 'ACİLDURUM',
    label: 'ACİL DURUM',
    clue: "Beklenmedik risklere ve krizlere karşı oluşturulan koruyucu ihtiyat fonu (İki kelime).",
  },
  {
    id: 'istek',
    number: 8,
    ...
    answer: 'İSTEK',
    label: 'İSTEK',
    clue: 'Zorunlu olmamakla birlikte yaşam standardını ve kişisel tatmini artıran arzular.',
  },
  {
    id: 'butce',
    number: 9,
    ...
    answer: 'BÜTÇE',
    label: 'BÜTÇE',
    clue: 'Gelir ve giderlerin belirli bir dönem için tasarlanmış planı.',
  },
  {
    id: 'gorunmez_gider',
    number: 10,
    ...
    answer: 'GÖRÜNMEZ',
    label: 'GÖRÜNMEZ',
    clue: 'Kullanılmayan abonelikler gibi hesaptan otomatik ve pasif olarak çıkan giderler.',
  },
];
...
const CHIP_TYPE = 'SHORT_LONG_TERM_GLOSSARY_ANSWER';
...
function ShortLongTermGlossaryPuzzleGame({ onComplete, onBack }: ShortLongTermGlossaryPuzzleProps) {
        ...
        <div className="bg-slate-900 rounded-3xl overflow-hidden shadow-2xl border border-slate-700">
          ...
          <div className="p-6 sm:p-8 text-center">
            ...
            <h1 className="text-2xl md:text-3xl font-black text-white mb-2">
              Kısa ve Uzun Vadeli Finansal Etki — Ekonomi Sözlüğü
            </h1>
  ...
  if (stage === 'finished') {
    ...
    const perf =
      wrongCount === 0
        ...
        : wrongCount <= 3
        ? { icon: '🌟', title: 'Harika İş!', sub: 'Kısa ve uzun vadeli finansal etki kavramlarına çok hakimsin.', grad: 'from-cyan-600 to-teal-500' }
        : wrongCount <= 6
    ...
    <div className="w-full max-w-7xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-cyan-600 to-teal-600 rounded-2xl px-5 py-3 mb-4 flex items-center justify-between shadow-lg flex-wrap gap-2">
        <div className="flex items-center gap-3">
          ...
          <span className="text-white font-black text-base">Kısa ve Uzun Vadeli Finansal Etki — Sürükle Bırak Bulmaca</span>
        </div>
        <div className="flex items-center gap-3">
...
export default function ShortLongTermGlossaryPuzzle(props: ShortLongTermGlossaryPuzzleProps) {
  return (
    <DndProvider backend={HTML5Backend}>
      <ShortLongTermGlossaryPuzzleGame {...props} />
    </DndProvider>
  );
}
