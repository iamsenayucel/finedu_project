...
interface MediaGlossaryPuzzleProps {
...
const WORDS: WordDef[] = [
  {
    ...
    answer: 'TEYİTÇİLİK',
    label: 'TEYİTÇİLİK',
    clue: 'Ortaya atılan şüpheli bir iddianın, şeffaf, tarafsız ve tekrarlanabilir bir metodoloji ile doğrulanması süreci.',
  },
  {
    id: 'manipulasyon',
    number: 2,
    ...
    answer: 'MANİPÜLASYON',
    label: 'MANİPÜLASYON',
    clue: 'Haberi yazan kişinin, senin korku veya açgözlülük gibi duygularını kullanarak seni belirli bir finansal karara itme çabasıdır.',
  },
  {
    id: 'birincil_kaynak',
    number: 3,
    ...
    row: 4,
    col: 2,
    answer: 'BİRİNCİLKAYNAK',
    label: 'BİRİNCİL KAYNAK',
    clue: 'Verinin ilk elden üretildiği, doğrudan araştırmayı yapan orijinal kaynaktır.',
  },
  {
    id: 'enflasyon',
    number: 4,
    ...
    answer: 'ENFLASYON',
    label: 'ENFLASYON',
    clue: 'Mal ve hizmetlerin fiyatlarının genel düzeyindeki sürekli artıştır.',
  },
  {
    id: 'fud',
    number: 5,
    ...
    answer: 'FUD',
    label: 'FUD',
    clue: 'İnsanları paniğe sürükleyip ellerindeki yatırımları sattırmak veya bir piyasayı kötülemek için yayılan stratejisidir.',
  },
  {
    id: 'zaman_tuzagi',
    number: 6,
    ...
    answer: 'ZAMANTUZAĞI',
    label: 'ZAMAN TUZAĞI',
    clue: '"Kontenjan doluyor", "Hemen tıkla" gibi ifadelerle düşünme süreni elinden alıp seni hatalı karar vermeye zorlayan taktik.',
  },
  {
    id: 'tufe',
    number: 7,
    ...
    answer: 'TÜFE',
    label: 'TÜFE',
    clue: 'Tüketici Fiyat Endeksi. Hanehalklarının tüketim amacıyla satın aldığı mal ve hizmetlerin fiyatlarındaki değişimi ölçer.',
  },
  {
    id: 'ufe',
    number: 8,
    ...
    answer: 'ÜFE',
    label: 'ÜFE',
    clue: 'Üretici Fiyat Endeksi. Üretici düzeyindeki fiyat değişimini ölçer.',
  },
  {
    id: 'volatilite',
    number: 9,
    ...
    answer: 'VOLATİLİTE',
    label: 'VOLATİLİTE',
    clue: 'Fiyatların kısa bir zaman diliminde yukarı ve aşağı yönlü sert hareketler yapmasıdır.',
  },
  {
    id: 'fomo',
    number: 10,
    ...
    answer: 'FOMO',
    label: 'FOMO',
    clue: '"Herkes kazanıyor, sen izliyorsun, hemen almalısın!" hissi yaratarak seni panikle yanlış karar vermeye iten taktik.',
  },
];
...
function MediaGlossaryPuzzleGame({ onComplete, onBack }: MediaGlossaryPuzzleProps) {
        ...
        <div className="bg-slate-900 rounded-3xl overflow-hidden shadow-2xl border border-slate-700">
          ...
          <div className="p-6 sm:p-8 text-center">
            ...
            <h1 className="text-2xl md:text-3xl font-black text-white mb-2">
              Finansal Medya Okuryazarlığı — Ekonomi Sözlüğü
            </h1>
  ...
  if (stage === 'finished') {
    ...
    const perf =
      wrongCount === 0
        ...
        : wrongCount <= 3
        ? { icon: '🌟', title: 'Harika İş!', sub: 'Finansal medya kavramlarına çok hakimsin.', grad: 'from-indigo-600 to-violet-500' }
        : wrongCount <= 6
...
export default function MediaGlossaryPuzzle(props: MediaGlossaryPuzzleProps) {
  return (
    <DndProvider backend={HTML5Backend}>
      <MediaGlossaryPuzzleGame {...props} />
    </DndProvider>
  );
}
